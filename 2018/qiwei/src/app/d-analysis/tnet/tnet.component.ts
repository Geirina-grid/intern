...
@Component({
  selector: 'app-tnet',
  templateUrl: './tnet.component.html',
  styleUrls: ['./tnet.component.css'],
...
export class TnetComponent implements OnInit, AfterViewInit, OnDestroy {
