...
export class DataQualityService {
  ...
  rundq(runtype: any, chosenprocess: any): Promise<any> {
    let reqUrl = this.runUrl;
    return this.http.post(reqUrl,JSON.stringify({runtype:runtype, processcount:chosenprocess}), { headers: this.headers })
      .toPromise()
