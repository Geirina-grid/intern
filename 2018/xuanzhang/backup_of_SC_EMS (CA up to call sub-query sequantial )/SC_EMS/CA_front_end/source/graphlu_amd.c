...
void _I_GraphLU_AMDSort(uint__t n, uint__t *ai, uint__t *ap, int__t *w, uint__t *ri, uint__t *rp)
{
	uint__t p, p2, i, j;
...
uint__t _I_GraphLU_AAT(uint__t n, uint__t *ai, uint__t *ap, int__t *len, int__t *tp)
{
...
void _I_GraphLU_AAT2(uint__t n, uint__t *ai, uint__t *ap, int__t *len, int__t *pe, int__t *sp, int__t *iw, int__t *tp)
{
...
void _I_GraphLU_AMD(int__t n, int__t pfree, int__t iwlen, int__t *pe, int__t *iw, \
...
/*	for (i=0; i<n; ++i)
	...
	_I_GraphLU_PostOrder(n, pe, nv, elen, w, head, next, last);
...
void _I_GraphLU_PostOrder(int__t n, int__t *parent, int__t *nv, int__t *fsize, int__t *order, int__t *child, int__t *sibling, int__t *stack)
{
	...
	for (i=0; i<n; ++i)
	{
		...
		{
			k = _I_GraphLU_PostTree(i, k, child, sibling, order, stack);
		}
	}
}
