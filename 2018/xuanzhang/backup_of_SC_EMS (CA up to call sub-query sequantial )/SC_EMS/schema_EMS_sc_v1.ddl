...
typedef tuple< caFrom int, caTo int, pfViolFrom uint, pfViolTo uint, pfViolTpye int, pfViolFrom_Name string (10), pfViolTo_Name string (10), line_Q1 double, pfSeverity double> ca_pf_detail
...
G double, B double, Sub string, longitude string, latitude string, OV int, UV int, Ri_vP double, Ri_vQ double, sumB double, sumG double, sumBi double, volt int, pos_x double, pos_y double, SE_Vm double, SE_Va double, PF_Vm double, PF_Va double)
...
CREATE DIRECTED EDGE topo_connect (from TopoND, to TopoND, edge_name string, area string, zone uint, tap_bus int, z_bus int, flag uint, R double, X double, hB double, line_Q1 double, line_Q2 double, line_Q3 double, control_bus int, side int, transformer_final_turns_ratio double, transformer_final_angle double, min_tap double, max_tap double, step_size double, min_volt double, max_volt double, M_P_TLPF double, M_Q_TLPF double, th double, em double, sh double, outage int, G double, B double, BIJ double, circuit uint, kcount double, P_TLPF double, Q_TLPF double, hbsum double, Ri_eP double, Ri_eQ double, CI int, k double, reverse double, tap_type_id string, CA_bridge int, mainland_side int, CA_solver int, Decision bool, SI double, volt double, device_type string, from_busname string, to_busname string, CSeverity double, CritiLine bool)
